...
activities = {
    ...
    "Track Team": {
        "description": "Train for speed, endurance, and competitive running events",
    ...
    "Drama Club": {
        "description": "Practice acting, stage presence, and performance for school productions",
    ...
    "Math Olympiad": {
        ...
        "max_participants": 10,
        "participants": ["ben@mergington.edu", "sara@mergington.edu"]
    }
}
